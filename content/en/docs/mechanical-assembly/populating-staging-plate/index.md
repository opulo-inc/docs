...
9. Slide the Up Ring Light into the {{< tooltip "Up Light Mount" "FDM-0019" >}}. The cable connector and LEDs should be facing the printed part, away from the camera in this photo.
...
16. Use four M3x30mm screws and four M3 nuts mount the whole assembly to the staging plate (if you have the fiberglass staging plate, these will be the nuts you installed in the previous step). The cable connector for the Up Ring Light should be facing down and to the left, away from the valve.
...
17. If you have the fiberglass PCB staging plate, note that this is where the foot will get installed when your LumenPnP is ready.
