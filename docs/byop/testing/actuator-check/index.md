...
![P value highlighted in gcode textbox](images/edit-ringlight-brightness.png){ loading=lazy }
...
!!! danger "Interposer Board"
    ...
    ![No Interposers Installed](images/IMG_1293.JPG){ loading=lazy }

    Interposer Boards Installed
    ![Interposer Boards Installed](images/IMG_1325.JPG){ loading=lazy }
